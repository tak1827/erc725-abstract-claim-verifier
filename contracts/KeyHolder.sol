...
contract KeyHolder is ERC725 {
        ...
        returns (bool)
    {
        ...
        if (_approve == true) {
            ...
            // (bool success, ) = _keyHolderData.executions[_id].to.call(_keyHolderData.executions[_id].data);
            (bool success, ) = executions[_id].to.call.value(executions[_id].value)(executions[_id].data);
            if (success) {
